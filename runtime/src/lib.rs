...
impl_opaque_keys! {
    pub struct SessionKeys { pub aura: Aura, pub grandpa: Grandpa, }
}
...
parameter_types! {
    ...
    pub RuntimeBlockWeights: BlockWeights = BlockWeights::with_sensible_defaults(Weight::from_parts(2 * WEIGHT_REF_TIME_PER_SECOND, u64::MAX), NORMAL_DISPATCH_RATIO);
    pub RuntimeBlockLength: BlockLength = BlockLength::builder().max_length(5 * 1024 * 1024).build();
...
impl pallet_minijam::Config for Runtime {
    ...
    type MaxPendingReports = ConstU32<64>;
